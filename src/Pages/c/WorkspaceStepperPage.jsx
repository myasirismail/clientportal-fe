...
import { Box, Button, Typography, Paper, TextField, Select, MenuItem, FormControl, IconButton, List, ListItem, ListItemText, ListItemSecondaryAction, FormControlLabel, Checkbox } from "@mui/material";
...
function getStepContent(step, reviewItems, setReviewItems) {
          ...
          <Paper variant="outlined" sx={{ p: 3, borderRadius: 2, mb: 2, background: 'transparent' }}>
            ...
            <Box sx={{ mb: 2 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', ml: 3, mb: 1 }}>
                <Typography variant="body2" sx={{ mr: 1 }}>Send a reminder every</Typography>
                <TextField
                  type="number"
                  size="small"
                  defaultValue={4}
                ...
                />
                <Typography variant="body2" sx={{ mr: 2 }}>days</Typography>
                <Typography variant="body2" sx={{ mr: 1 }}>End after</Typography>
                <TextField
                  type="number"
                  size="small"
                  defaultValue={3}
                  ...
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    {reminders.map((reminder, index) => (
                      <Box key={index} sx={{ display: 'flex', alignItems: 'center', mb: 2, gap: 1 }}>
                        <Typography variant="body2" sx={{ minWidth: 100 }}>Send reminder</Typography>
                        <TextField
                          size="small"
                          value={reminder.date}
                          sx={{ 
                        ...
                        <Typography variant="body2" sx={{ ml: 1 }}>due date</Typography>
                        <Button
                          size="small"
                          sx={{ 
                            ml: 1,
            ...
            <Box sx={{ mb: 1 }}>
              <FormControlLabel
                control={<Checkbox />}
                label={<Typography variant="body2">Enable recipient verification using a One Time Password.</Typography>}
              />
            </Box>
            <Box>
              <FormControlLabel
    ...
    <Box sx={{ width: "100%", height: "90%", padding: "10px 20px", backgroundColor: "#F8F9FF" }}>
      ...
      >
        {activeStep === steps.length ? (
          ...
          getStepContent(activeStep, reviewItems, setReviewItems)
        )}
      </Paper>
      {activeStep !== steps.length && (
        <Paper 
