    ...
    <Box>
      ...
      <Box>
        ...
        <Box sx={{ display: "flex", alignItems: "center", mb: 5 }}>
          ...
          <Typography variant="h5" sx={{ fontWeight: 700, color: "#2d223c", letterSpacing: 1 }}>
            MyTask
          </Typography>
        </Box>
        {/* Navigation Links */}
        ...
        {/* Projects Section */}
        <Box sx={{ mt: 5 }}>
          <Typography variant="subtitle2" sx={{ color: "#b0b3c6", fontWeight: 700, mb: 1, letterSpacing: 1 }}>
            PROJECTS
          </Typography>
          <Stack spacing={1.2}>
            {projects.map((proj) => (
              <Box key={proj.name} sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                <Box
                  sx={{
                    ...
                    borderRadius: "50%",
                    bgcolor: proj.color,
                    boxShadow: proj.active ? "0 0 0 3px #e0e7ff" : "none",
                  }}
                />
                <Typography
                  sx={{ color: proj.active ? "#2d223c" : "#64748b", fontWeight: proj.active ? 700 : 500, fontSize: 16 }}
                >
                  {proj.name}
                </Typography>
              </Box>
